...
function Footer() {
  return (
    <div>
      <MDBFooter style={{backgroundColor:"blue"}} className=' text-center text-lg-start text-muted '>
    

      <section className='mt-3'>
        <MDBContainer className='text-center text-md-start mt-5'>
          <MDBRow className='mt-3'>
            <MDBCol md="3" lg="4" xl="3" className='mx-auto mb-4' style={{color:"black"}}>
            ...
            <MDBCol md="2" lg="2" xl="2" className='mx-auto mb-4'>
              <h6 className='text-uppercase fw-bold mb-4' style={{color:"black"}}>Links </h6>
              <p>
